  ...
  try {
    ...
    switch (format) {
      case "json":
        ...
        break;
      case "txt":
        exportContent = formatAsText(content);
        contentType = "text/plain";
        fileExtension = "txt";
        break;
      case "pdf":
      case "docx":
        // For PDF/DOCX, return formatted text (client can convert if needed)
        exportContent = formatAsText(content);
        contentType = "text/plain";
        fileExtension = "txt";
        break;
    ...
    const finalFilename = `${filename || "document"}_${Date.now()}.${fileExtension}`;
    ...
    try {
        ...
        switch (mode) {
            ...
            case "summary":
                ...
                break;
            case "lop":
                result = await openaiLib.runMedicalIntelligence("lop", {
                    ...payload,
                    ragContext,
                    model,
                    complexity
                ...
                break;
            case "pip":
                result = await openaiLib.runMedicalIntelligence("pip", {
                    ...payload,
                    ragContext,
                    model,
                    complexity
                ...
                break;
            case "attorney":
                result = await openaiLib.runMedicalIntelligence("attorney", {
                    ...payload,
                    ragContext,
                    model,
                    complexity
                ...
                break;
            case "therapist":
                result = await openaiLib.runMedicalIntelligence("therapist", {
                    ...payload,
                    ragContext,
                    model,
                    complexity
