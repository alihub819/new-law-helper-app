    ...
    <SidebarLayout>
      <div className="p-6">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          <Card role="button" className="cursor-pointer hover:shadow-md transition-shadow" onClick={() => navigateToAISearch('legal-research')} data-testid="card-legal-research">
          ...
          <Card role="button" className="cursor-pointer hover:shadow-md transition-shadow" onClick={() => navigateToAISearch('brief-summarizer')} data-testid="card-brief-summarizer">
            <CardContent className="p-6">
              <div className="flex items-center space-x-4">
          ...
          <Card role="button" className="cursor-pointer hover:shadow-md transition-shadow" onClick={() => navigateToAISearch('risk-analysis')} data-testid="card-risk-analysis">
            <CardContent className="p-6">
              <div className="flex items-center space-x-4">
              ...
              <div className="h-[300px] w-full">
                <ResponsiveContainer width="100%" height="100%">
                  <PieChart>
                    <Pie
                      data={[
                        { name: 'Search', value: Array.isArray(searchHistory) ? searchHistory.filter((i: any) => i.type === 'legal-research').length : 0 },
                        { name: 'Analysis', value: Array.isArray(searchHistory) ? searchHistory.filter((i: any) => i.type === 'brief-summarizer').length : 0 },
                        { name: 'Risk', value: Array.isArray(searchHistory) ? searchHistory.filter((i: any) => i.type === 'risk-analysis').length : 0 },
                        { name: 'Other', value: Array.isArray(searchHistory) ? searchHistory.filter((i: any) => !['legal-research', 'brief-summarizer', 'risk-analysis'].includes(i.type)).length : 0 },
                      ].filter(d => d.value > 0)}
                      cx="50%"
                      cy="50%"
                      innerRadius={60}
